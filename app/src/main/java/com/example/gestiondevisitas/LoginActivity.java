...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlogin = (Button) findViewById(R.id.btnsignip1);
            ...
            public void onClick(View view) {
                ...
                if(user.equals("")||pass.equals(""))
                    ...
                    if(checkuserpass==true){
                        ...
                        Toast.makeText(LoginActivity.this,"Sesión exitoso",Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(getApplicationContext(),NavegationActivity.class);
